                                                        ...
                                                        <div class="block_view">
                                                            ...
                                                            <label for="wcpa_show_meta_in_order"><?php _e('Show in Order', 'woo-custom-product-addons'); ?>
                                                                <span style="color: #e50101;font-size: 12px;padding-left: 5px;"> <?php
	                                                                _e('If unchecked, It will add \'_\' for all field labels after checkout, then it will be hidden from <strong>order details</strong>, <strong>email</strong> and <strong>invoice</strong> as well. ', 'woo-custom-product-addons');
                                                                 ?></span>
                                                            </label>
                        ...
                        <div class="premium wcpa_clearfix">
                            ...
                            <div class="premium_right">
                                <div class="outer">
                                    ...
                                    <ul>
                                        <li>
                                            <strong>22+ types of custom product fields.</strong>
                                        </li>
                                        <li>
                                            <strong>Conditional logic:</strong> Show or hide some fields based on the value selected for other fields.
                                        </li>
                                        <li>
                                            <strong>Fields based on variations:</strong> Show or hide some fields based on the product variation selected.
                                        </li>
                                        <li>
                                            <strong>Set price for fields:</strong> Price can be set for all the fields available. The price can be a fixed value, percentage value of the product base price.
                                        </li>
                                        <li>
                                            <strong>Custom price formula:</strong> To calculate price using mathematical formula based on user input value, product quantity, product base price, and based on the prices of other fields as well.
                                        </li>
                                        <li>
                                            <strong>WPML</strong> and <strong>Polylang</strong> support.
                                        </li>
                                    </ul>
                                </div>
                            </div>
