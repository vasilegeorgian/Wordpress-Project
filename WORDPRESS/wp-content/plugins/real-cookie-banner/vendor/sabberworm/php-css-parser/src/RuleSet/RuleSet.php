 ...
 */
abstract class RuleSet implements \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Renderable, \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Comment\Commentable
{
    /**
     ...
     */
    public static function parseRuleSet(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Parsing\ParserState $oParserState, \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\RuleSet\RuleSet $oRuleSet)
    {
     ...
     * @return void
     */
    public function addRule(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $oRule, \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $oSibling = null)
    {
        $sRule = $oRule->getRule();
    ...
    public function getRules($mRule = null)
    {
        ...
        \usort($aResult, function (\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $first, \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Rule\Rule $second) {
     ...
     * @return string
     */
    protected function renderRules(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\OutputFormat $oOutputFormat)
    {
        $sResult = '';
        $bIsFirst = \true;
