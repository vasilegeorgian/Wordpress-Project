...
class Charset implements \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Property\AtRule
{
     ...
     * @param int $iLineNo
     */
    public function __construct(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\CSSString $oCharset, $iLineNo = 0)
    {
    ...
    {
        $sCharset = $sCharset instanceof \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\CSSString ? $sCharset : new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\CSSString($sCharset);
