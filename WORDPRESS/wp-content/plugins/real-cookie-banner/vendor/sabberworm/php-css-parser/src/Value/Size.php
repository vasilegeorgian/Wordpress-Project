...
class Size extends \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\PrimitiveValue
{
     ...
     */
    public static function parse(\DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $bIsColorComponent = \false)
    {
        $sSize = '';
        ...
        return new \DevOwl\RealCookieBanner\Vendor\Sabberworm\CSS\Value\Size((float) $sSize, $sUnit, $bIsColorComponent, $oParserState->currentLine());
    }
    /**
