...
$examples = ['php embera', 'php embera --fake 1', 'php embera --fake 1 --only-array 1 --responsive 1'];
...
$fake = \DevOwl\RealCookieBanner\Vendor\Embera\Embera::DISABLE_FAKE_RESPONSES;
if (!empty($options['fake'])) {
    $fake = \DevOwl\RealCookieBanner\Vendor\Embera\Embera::ONLY_FAKE_RESPONSES;
}
$responsive = \false;
...
$embera = new \DevOwl\RealCookieBanner\Vendor\Embera\Embera(['fake_responses' => $fake, 'responsive' => $responsive, 'https' => $https]);
