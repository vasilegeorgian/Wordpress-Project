 ...
 *
 */
class Orbitvu extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://orbitvu.co/service/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['orbitvu.co'];
    /** inline {@inheritdoc} */
