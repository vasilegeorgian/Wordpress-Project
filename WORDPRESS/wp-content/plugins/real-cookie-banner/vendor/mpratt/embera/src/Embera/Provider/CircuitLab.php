 ...
 *
 */
class CircuitLab extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.circuitlab.com/circuit/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['circuitlab.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'width="{width}"';
        $attr[] = 'height="{height}"';
        return ['type' => 'rich', 'provider_name' => 'CircuitLab', 'provider_url' => 'https://www.circuitlab.com/', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
