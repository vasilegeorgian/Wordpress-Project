 ...
 *
 */
class ActBlue extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://secure.actblue.com/cf/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.actblue.com'];
    /** inline {@inheritdoc} */
