 ...
 *
 */
class ChartBlocks extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'http://embed.chartblocks.com/1.0/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['public.chartblocks.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'width="{width}"';
        $attr[] = 'frameborder="0"';
        return ['type' => 'rich', 'provider_name' => 'ChartBlocks', 'provider_url' => 'https://chartblocks.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
