 ...
 *
 */
class Giphy extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://giphy.com/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['giphy.com', 'gph.is', 'media.giphy.com'];
    /** inline {@inheritdoc} */
    ...
    {
        return (bool) (\preg_match('~giphy\\.com/(gifs|stickers|clips)/([^/]+)~i', (string) $url) || \preg_match('~giphy\\.com/media/([^/]+)/giphy.gif$~i', (string) $url) || \preg_match('~gph\\.is/g/([^/]+)$~i', (string) $url));
    }
    /** inline {@inheritdoc} */
