 ...
 */
class Gyazo extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.gyazo.com/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['gyazo.com'];
    /** inline {@inheritdoc} */
