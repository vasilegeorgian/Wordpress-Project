 ...
 */
class GetShow extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.getshow.io/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.getshow.io'];
    /** inline {@inheritdoc} */
    ...
    {
        return (bool) (\preg_match('~getshow\\.io/share/([^/]+)~i', (string) $url) || \preg_match('~getshow\\.io/embed/iframe/~i', (string) $url));
    }
    /** inline {@inheritdoc} */
