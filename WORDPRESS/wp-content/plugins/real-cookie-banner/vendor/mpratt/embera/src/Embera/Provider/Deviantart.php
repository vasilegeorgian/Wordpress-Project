 ...
 */
class Deviantart extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://backend.deviantart.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.deviantart.com', 'fav.me', 'sta.sh'];
    /** inline {@inheritdoc} */
