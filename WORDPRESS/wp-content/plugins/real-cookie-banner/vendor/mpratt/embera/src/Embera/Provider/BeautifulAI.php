 ...
 *
 */
class BeautifulAI extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.beautiful.ai/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['beautiful.ai'];
    /** inline {@inheritdoc} */
