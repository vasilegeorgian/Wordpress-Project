 ...
 */
class SproutVideo extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://sproutvideo.com/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['sproutvideo.com', '.vids.io'];
    /** inline {@inheritdoc} */
