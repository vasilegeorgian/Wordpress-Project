 ...
 */
class Dadan extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://app.dadan.io/api/video/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['app.dadan.io', 'stage.dadan.io'];
    /** inline {@inheritdoc} */
