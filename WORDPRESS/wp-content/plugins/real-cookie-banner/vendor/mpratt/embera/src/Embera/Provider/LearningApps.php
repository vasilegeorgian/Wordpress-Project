 ...
 *
 */
class LearningApps extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://learningapps.org/oembed.php?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['learningapps.org'];
    /** inline {@inheritdoc} */
