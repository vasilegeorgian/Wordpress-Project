 ...
 *
 */
class Roomshare extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://roomshare.jp/en/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['roomshare.jp'];
    /** inline {@inheritdoc} */
