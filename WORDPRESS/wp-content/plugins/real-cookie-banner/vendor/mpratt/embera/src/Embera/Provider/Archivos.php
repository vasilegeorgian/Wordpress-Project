 ...
 *
 */
class Archivos extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://app.archivos.digital/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.archivos.digital'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'Archivos', 'provider_url' => 'https://app.archivos.digital/', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . ' ></iframe>'];
    }
}
