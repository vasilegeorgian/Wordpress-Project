 ...
 * @link https://coub.com
 */
class Coub extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://coub.com/api/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['coub.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'width="{width}"';
        $attr[] = 'height="{height}"';
        return ['type' => 'video', 'provider_name' => 'Coub', 'provider_url' => 'http://coub.com/', 'url' => (string) $this->url, 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
