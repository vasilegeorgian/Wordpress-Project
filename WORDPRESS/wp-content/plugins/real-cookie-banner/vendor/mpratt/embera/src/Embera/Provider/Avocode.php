 ...
 *
 */
class Avocode extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://stage-embed.avocode.com/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.avocode.com'];
    /** inline {@inheritdoc} */
