 ...
 */
class LocalVoicesNetwork extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://embed.lvn.org/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.lvn.org'];
    /** inline {@inheritdoc} */
