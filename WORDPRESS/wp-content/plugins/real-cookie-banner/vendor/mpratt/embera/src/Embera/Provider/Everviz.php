 ...
 */
class Everviz extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.everviz.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['app.everviz.com'];
    /** inline {@inheritdoc} */
