 ...
 *
 */
class Kit extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://embed.kit.co/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['kit.com', 'kit.co'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'scrolling="no"';
        return ['type' => 'rich', 'provider_name' => 'Kit', 'provider_url' => 'https://kit.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
