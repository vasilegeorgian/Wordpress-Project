 ...
 *
 */
class Viously extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.viously.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['viously.com'];
    /** inline {@inheritdoc} */
