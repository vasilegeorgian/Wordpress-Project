 ...
 */
class Flickr extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.flickr.com/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['flickr.com', 'flic.kr'];
    /** inline {@inheritdoc} */
    protected $httpsSupport = \true;
    /** inline {@inheritdoc} */
    public function validateUrl(\DevOwl\RealCookieBanner\Vendor\Embera\Url $url)
    {
        return (bool) (\preg_match('~/photos/(?:[^/]+)/(?:[0-9]+)/?~i', (string) $url) || \preg_match('~flic\\.kr/p/(?:[^/]+)~i', (string) $url));
    }
    /** inline {@inheritdoc} */
