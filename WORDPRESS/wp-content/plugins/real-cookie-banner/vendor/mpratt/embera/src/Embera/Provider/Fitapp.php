 ...
 */
class Fitapp extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://fitapp.pro/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['fitapp.pro', 'mybeweeg.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'src="' . $embedUrl . '"';
        $attr[] = 'width="{width}"';
        return ['type' => 'rich', 'provider_name' => 'Fitapp', 'provider_url' => 'https://fitapp.pro', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
