 ...
 *
 */
class Apester extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://display.apester.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['renderer.apester.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'width="{width}"';
        $attr[] = 'height="{height}"';
        return ['type' => 'rich', 'provider_name' => 'Apester', 'provider_url' => 'https://www.apester.com/', 'title' => 'Unknown title', 'html' => '<div style="width: {width}; height: {height}"><iframe ' . \implode(' ', $attr) . ' /></div>'];
    }
}
