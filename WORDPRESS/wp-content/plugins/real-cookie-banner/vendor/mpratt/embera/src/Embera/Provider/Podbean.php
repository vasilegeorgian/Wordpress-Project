 ...
 *
 */
class Podbean extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.podbean.com/v1/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.podbean.com'];
    /** inline {@inheritdoc} */
