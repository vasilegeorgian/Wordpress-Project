 ...
 */
class Synthesia extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://69jr5v75rc.execute-api.eu-west-1.amazonaws.com/prod/v2/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['share.synthesia.io'];
    /** inline {@inheritdoc} */
