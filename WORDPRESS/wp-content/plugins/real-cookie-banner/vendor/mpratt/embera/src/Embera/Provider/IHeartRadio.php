 ...
 */
class IHeartRadio extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.iheart.com/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['iheart.com'];
    /** inline {@inheritdoc} */
