 ...
 */
class GettyImages extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://embed.gettyimages.com/oembed?format=json&caller=embera';
    /** inline {@inheritdoc} */
    protected static $hosts = ['gty.im', '*.gettyimages.com', '*.gettyimages.com.mx', '*.gettyimages.com.au', '*.gettyimages.com.be', '*.gettyimages.com.br', '*.gettyimages.com.ca', '*.gettyimages.com.de', '*.gettyimages.es', '*.gettyimages.fr', '*.gettyimages.in', '*.gettyimages.ie', '*.gettyimages.it', '*.gettyimages.nl', '*.gettyimages.no', '*.gettyimages.co.nz', '*.gettyimages.at', '*.gettyimages.pt', '*.gettyimages.ch', '*.gettyimages.fi', '*.gettyimages.se', '*.gettyimages.ae', '*.gettyimages.co.uk', '*.gettyimages.hk', '*.gettyimages.co.jp'];
    /** inline {@inheritdoc} */
    ...
    public function modifyResponse(array $response = [])
    {
        ...
        $check = ['url', 'thumbnail_url', 'thumbnail_width', 'thumbnail_height', 'title'];
        foreach ($check as $c) {
            if (!isset($response[$c])) {
                return $response;
            }
