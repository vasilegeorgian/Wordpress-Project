 ...
 *
 */
class OraTV extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.ora.tv/oembed/0_{url_id}?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['ora.tv'];
    /** inline {@inheritdoc} */
