 ...
 *
 */
class ScribbleMaps extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.scribblemaps.com/api/services/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['scribblemaps.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'ScribbleMaps', 'provider_url' => 'https://scribblemaps.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
