 ...
 */
class ScreenNine extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.screen9.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.screen9.tv', 'console.screen9.com'];
    /** inline {@inheritdoc} */
