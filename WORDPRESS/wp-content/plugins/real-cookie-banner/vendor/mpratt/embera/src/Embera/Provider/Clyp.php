 ...
 * @link https://clyp.it
 */
class Clyp extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.clyp.it/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['clyp.it'];
    /** inline {@inheritdoc} */
