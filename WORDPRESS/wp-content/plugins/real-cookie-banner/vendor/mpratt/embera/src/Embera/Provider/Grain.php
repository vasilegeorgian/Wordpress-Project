 ...
 *
 */
class Grain extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'http://api.grain.com/_/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['grain.com', 'grain.co'];
    /** inline {@inheritdoc} */
