 ...
 *
 */
class Kmdr extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.kmdr.sh/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['app.kmdr.sh'];
    /** inline {@inheritdoc} */
