 ...
 *
 */
class SongLink extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://song.link/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['song.link', 'album.link', 'artist.link', 'playlist.link', 'pods.link', 'mylink.page', 'odesli.co'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'SongLink', 'provider_url' => 'https://song.link', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
