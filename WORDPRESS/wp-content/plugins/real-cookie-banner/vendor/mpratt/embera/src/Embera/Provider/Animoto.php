 ...
 *
 */
class Animoto extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'http://animoto.com/oembeds/create?format=json&ssl=true';
    /** inline {@inheritdoc} */
    protected static $hosts = ['animoto.com'];
    /** inline {@inheritdoc} */
