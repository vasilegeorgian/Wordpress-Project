 ...
 *
 */
class Gfycat extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.gfycat.com/v1/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['gfycat.com'];
    /** inline {@inheritdoc} */
    ...
    {
        $invalid = ['api', 'terms', 'privacy', 'about', 'dmca', 'search', 'popular-gifs', 'gaming', 'stickers', 'sound-gifs', 'discover', 'upload', 'create', 'login', 'signup', 'jobs', 'partners', 'blog', 'faq', 'support', 'gifbrewery', 'slack', 'pro'];
    ...
    public function getFakeResponse()
    {
        ...
        $html[] = '</div>';
        return ['type' => 'video', 'provider_name' => 'Gfycat', 'provider_url' => 'https://gfycat.com', 'title' => 'Unknown title', 'html' => \implode('', $html)];
    }
}
