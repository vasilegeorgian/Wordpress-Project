 ...
 *
 */
class AnnieMusic extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.anniemusic.app/api/v1/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['anniemusic.app'];
    /** inline {@inheritdoc} */
