 ...
 */
class HiHaHo extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://player.hihaho.com/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.hihaho.com'];
    /** inline {@inheritdoc} */
