 ...
 */
class VidMount extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://vidmount.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['vidmount.com'];
    /** inline {@inheritdoc} */
