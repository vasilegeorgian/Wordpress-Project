 ...
 */
class Bookingmood extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://bookingmood.com/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['bookingmood.com'];
    /** inline {@inheritdoc} */
