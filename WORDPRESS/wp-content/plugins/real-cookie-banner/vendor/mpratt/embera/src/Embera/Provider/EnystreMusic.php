 ...
 */
class EnystreMusic extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://music.enystre.com/oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['music.enystre.com'];
    /** inline {@inheritdoc} */
