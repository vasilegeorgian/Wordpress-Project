 ...
 */
class Vidyard extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.vidyard.com/dashboard/v1.1/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.vidyard.com'];
    /** inline {@inheritdoc} */
