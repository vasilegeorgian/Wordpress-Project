 ...
 *
 */
class Rcvis extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://rcvis.com/oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['rcvis.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => '', 'provider_name' => 'Rcvis', 'provider_url' => 'https://rcvis.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
