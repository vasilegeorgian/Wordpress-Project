 ...
 *
 */
class Kickstarter extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.kickstarter.com/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['kickstarter.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'frameborder="0"';
        $attr[] = 'scrolling="no"';
        return ['type' => 'rich', 'provider_name' => 'Kickstarter', 'provider_url' => 'https://kickstarter.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
