 ...
 *
 */
class Sketchfab extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://sketchfab.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['sketchfab.com'];
    /** inline {@inheritdoc} */
