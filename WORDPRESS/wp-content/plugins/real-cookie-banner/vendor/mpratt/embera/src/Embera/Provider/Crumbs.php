 ...
 * @link https://crumb.sh
 */
class Crumbs extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://crumb.sh/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['crumb.sh'];
    /** inline {@inheritdoc} */
