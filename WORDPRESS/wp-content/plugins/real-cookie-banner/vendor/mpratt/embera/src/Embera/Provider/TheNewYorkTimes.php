 ...
 *
 */
class TheNewYorkTimes extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.nytimes.com/svc/oembed/json/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['nytimes.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'TheNewYorkTimes', 'provider_url' => 'https://nytimes.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
