 ...
 *
 */
class Framer extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.framer.com/web/oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['framer.com'];
    /** inline {@inheritdoc} */
