 ...
 */
class Smeme extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://open.smeme.com/api/oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['open.smeme.com'];
    /** inline {@inheritdoc} */
