 ...
 */
class Adilo extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://adilo.bigcommand.com/web/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['adilo.bigcommand.com'];
    /** inline {@inheritdoc} */
