 ...
 */
class Odysee extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://odysee.com/$/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['odysee.com'];
    /** inline {@inheritdoc} */
