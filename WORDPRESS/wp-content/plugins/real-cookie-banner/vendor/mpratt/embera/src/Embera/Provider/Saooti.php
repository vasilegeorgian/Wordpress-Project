 ...
 *
 */
class Saooti extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://octopus.saooti.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['octopus.saooti.com'];
    /** inline {@inheritdoc} */
