 ...
 *
 */
class CodeSandbox extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://codesandbox.io/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.codesandbox.io'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'CodeSandbox', 'provider_url' => 'http://codesandbox.io/', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
