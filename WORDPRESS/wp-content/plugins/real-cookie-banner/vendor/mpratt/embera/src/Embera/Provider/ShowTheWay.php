 ...
 */
class ShowTheWay extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://showtheway.io/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['showtheway.io'];
    /** inline {@inheritdoc} */
