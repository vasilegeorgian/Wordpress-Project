 ...
 */
class MicrosoftStream extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://web.microsoftstream.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.microsoftstream.com'];
    /** inline {@inheritdoc} */
