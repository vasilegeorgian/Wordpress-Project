 ...
 *
 */
class Blogcast extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://app.blogcast.host/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['blogcast.host', 'app.blogcast.host'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'Blogcast', 'provider_url' => 'https://blogcast.host', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
