 ...
 *
 */
class Wordpress extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://public-api.wordpress.com/oembed/?format=json&for=embera';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.wordpress.com', 'wp.me'];
    /** inline {@inheritdoc} */
