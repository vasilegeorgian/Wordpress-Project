 ...
 */
class Instagram extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://graph.facebook.com/v12.0/instagram_oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['instagram.com', 'instagr.am'];
    /** inline {@inheritdoc} */
    ...
    {
        return (bool) (\preg_match('~(instagram\\.com|instagr\\.am)/(?:p|tv|reel)/([^/]+)/?$~i', (string) $url) || \preg_match('~(instagram\\.com|instagr\\.am)/([^/]+)/(?:p|tv|reel)/([^/]+)/?$~i', (string) $url));
    }
    /** inline {@inheritdoc} */
