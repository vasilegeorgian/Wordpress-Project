 ...
 *
 */
class Buttondown extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://buttondown.email/embed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['buttondown.email'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'src="' . $embedUrl . '"';
        return ['type' => 'rich', 'provider_name' => 'Buttondown', 'provider_url' => 'https://buttondown.email', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
