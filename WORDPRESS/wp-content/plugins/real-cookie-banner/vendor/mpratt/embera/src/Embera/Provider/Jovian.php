 ...
 */
class Jovian extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.jovian.ai/oembed.json?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['jovian.ml', 'jovian.ai'];
    /** inline {@inheritdoc} */
