 ...
 *
 */
class MixCloud extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.mixcloud.com/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['mixcloud.com'];
    /** inline {@inheritdoc} */
