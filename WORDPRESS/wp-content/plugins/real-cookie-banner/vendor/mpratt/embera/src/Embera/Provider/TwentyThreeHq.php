 ...
 *
 */
class TwentyThreeHq extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'http://www.23hq.com/23/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['23hq.com'];
    /** inline {@inheritdoc} */
