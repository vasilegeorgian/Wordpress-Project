 ...
 *
 */
class SapoVideos extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://rd.videos.sapo.pt/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['videos.sapo.pt', 'rd.videos.sapo.pt'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'video', 'provider_name' => 'SapoVideos', 'provider_url' => 'https://videos.sapo.pt', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
