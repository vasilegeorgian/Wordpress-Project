 ...
 */
class Imgur extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.imgur.com/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['imgur.com'];
    /** inline {@inheritdoc} */
