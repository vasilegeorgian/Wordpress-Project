 ...
 *
 */
class UpecPod extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://pod.u-pec.fr/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['pod.u-pec.fr'];
    /** inline {@inheritdoc} */
