 ...
 */
class RunKit extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://embed.runkit.com/oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['runkit.com'];
    /** inline {@inheritdoc} */
