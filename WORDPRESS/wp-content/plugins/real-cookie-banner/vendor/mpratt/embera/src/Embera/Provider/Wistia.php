 ...
 *
 */
class Wistia extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://fast.wistia.com/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.wistia.com'];
    /** inline {@inheritdoc} */
    ...
    {
        return (bool) (\preg_match('~wistia\\.com/embed/(iframe|playlists)/([^/]+)~i', (string) $url) || \preg_match('~wistia\\.com/medias/([^/]+)~i', (string) $url));
    }
    /** inline {@inheritdoc} */
