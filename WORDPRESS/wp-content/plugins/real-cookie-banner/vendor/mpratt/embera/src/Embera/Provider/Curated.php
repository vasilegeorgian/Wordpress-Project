 ...
 *
 */
class Curated extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.curated.co/oembed';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.curated.co'];
    /** inline {@inheritdoc} */
