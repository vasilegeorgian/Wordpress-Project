 ...
 */
class Chroco extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://chroco.ooo/embed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['chroco.ooo'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => '', 'provider_name' => 'Chroco', 'provider_url' => 'https://chroco.ooo', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
