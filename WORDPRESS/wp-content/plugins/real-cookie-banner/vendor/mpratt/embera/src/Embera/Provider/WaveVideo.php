 ...
 *
 */
class WaveVideo extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://embed.wave.video/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['watch.wave.video', 'embed.wave.video'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'video', 'provider_name' => 'WaveVideo', 'provider_url' => 'https://wave.video', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
