...
abstract class ProviderAdapter
{
    ...
    {
        $this->config = $config;
        $this->url = $this->normalizeUrl(new \DevOwl\RealCookieBanner\Vendor\Embera\Url($url));
    }
    /** inline {@inheritdoc} */
    public function getParams()
    {
        ...
        return \array_filter(\array_merge($params, ['url' => $this->getUrl()]));
    }
    /** inline {@inheritdoc} */
    ...
    /** inline {@inheritdoc} */
    public function getUrl($asString = \true)
    {
        if ($asString) {
