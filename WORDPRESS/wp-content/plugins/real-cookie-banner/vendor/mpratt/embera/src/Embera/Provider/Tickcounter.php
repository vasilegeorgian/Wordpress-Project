 ...
 *
 */
class Tickcounter extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.tickcounter.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['tickcounter.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'scrolling="no"';
        $attr[] = 'title=""';
        return ['type' => 'rich', 'provider_name' => 'Tickcounter', 'provider_url' => 'https://tickcounter.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
