 ...
 */
class Codepoints extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://codepoints.net/api/v1/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['codepoints.net'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'rich', 'provider_name' => 'Codepoints.net', 'provider_url' => 'http://codepoints.net/', 'thumbnail_url' => 'http://codepoints.net/api/v1/glyph/' . $m['1'], 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
