 ...
 *
 */
class Padlet extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://padlet.com/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['padlet.com'];
    /** inline {@inheritdoc} */
