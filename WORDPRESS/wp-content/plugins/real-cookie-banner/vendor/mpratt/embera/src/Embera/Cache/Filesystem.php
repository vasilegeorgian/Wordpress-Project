 ...
 * filesystem.
 */
class Filesystem extends \DevOwl\RealCookieBanner\Vendor\Embera\Cache\CacheAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Cache\CacheInterface
{
    ...
    public function set($key, $value, $ttl = null)
    {
        ...
        $createFile = \file_put_contents($this->getTargetFile($key), \serialize(['expire_time' => (int) $expiration, 'expire_time_date' => \date('Y-m-d H:i:s', $expiration), 'created' => \date('Y-m-d H:i:s'), 'content' => $value]), \LOCK_EX);
