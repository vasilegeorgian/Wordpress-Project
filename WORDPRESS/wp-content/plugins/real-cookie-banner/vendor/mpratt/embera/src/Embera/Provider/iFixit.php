 ...
 *
 */
class iFixit extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.ifixit.com/Embed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['ifixit.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'frameborder="0"';
        return ['type' => 'rich', 'provider_name' => 'iFixit', 'provider_url' => 'https://ifixit.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
