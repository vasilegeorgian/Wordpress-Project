 ...
 *
 */
class GeographUk extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.geograph.org.uk/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.geograph.org.uk', '*.geograph.co.uk', '*.geograph.ie'];
    /** inline {@inheritdoc} */
