 ...
 *
 */
class Lumiere extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://admin.lumiere.is/api/services/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.lumiere.is'];
    /** inline {@inheritdoc} */
