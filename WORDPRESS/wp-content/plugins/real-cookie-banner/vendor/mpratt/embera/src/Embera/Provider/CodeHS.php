 ...
 */
class CodeHS extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://codehs.com/api/sharedprogram/1/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['codehs.com'];
    /** inline {@inheritdoc} */
