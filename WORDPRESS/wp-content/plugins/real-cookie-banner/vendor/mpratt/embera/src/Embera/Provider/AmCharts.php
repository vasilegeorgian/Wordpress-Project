 ...
 *
 */
class AmCharts extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'http://live.amcharts.com/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['live.amcharts.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'src="' . $embedUrl . '"';
        $attr[] = 'frameborder="0" ';
        return ['type' => 'rich', 'provider_name' => 'amCharts', 'provider_url' => 'https://www.amcharts.com/', 'title' => 'Unknown title', 'thumbnail_url' => 'http://generated.amcharts.com/' . \substr($matches['1'], 0, 2) . '/' . $matches['1'] . '-full.png', 'canonical' => $embedUrl . '/', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
