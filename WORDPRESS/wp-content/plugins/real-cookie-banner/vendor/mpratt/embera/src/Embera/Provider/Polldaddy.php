 ...
 *
 */
class Polldaddy extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.crowdsignal.com/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.poll.fm', '*.survey.fm'];
    /** inline {@inheritdoc} */
    ...
    {
        return (bool) (\preg_match('~polldaddy\\.com/(?:poll|s|ratings)/(?:[^/]+)/?$~i', (string) $url) || \preg_match('~(?:poll|survey)\\.fm/([^/]+)~i', (string) $url));
    }
    /** inline {@inheritdoc} */
