 ...
 *
 */
class Nfb extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://www.nfb.ca/remote/services/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['nfb.ca'];
    /** inline {@inheritdoc} */
