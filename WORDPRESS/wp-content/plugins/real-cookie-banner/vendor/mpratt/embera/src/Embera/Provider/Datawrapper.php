 ...
 */
class Datawrapper extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://api.datawrapper.de/v3/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['datawrapper.dwcdn.net'];
    /** inline {@inheritdoc} */
