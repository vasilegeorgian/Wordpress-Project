 ...
 *
 */
class Matterport extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://my.matterport.com/api/v1/models/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.matterport.com'];
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        $attr[] = 'src="' . $this->url . '"';
        return ['type' => 'rich', 'provider_name' => 'Matterport', 'provider_url' => 'https://matterport.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
