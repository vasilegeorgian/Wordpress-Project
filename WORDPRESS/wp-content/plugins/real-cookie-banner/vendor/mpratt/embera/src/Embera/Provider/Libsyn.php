 ...
 */
class Libsyn extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://oembed.libsyn.com/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.libsyn.com'];
    /** inline {@inheritdoc} */
