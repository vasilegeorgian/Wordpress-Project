 ...
 *
 */
class Hearthis extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://hearthis.at/oembed/?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['hearthis.at'];
    /** inline {@inheritdoc} */
