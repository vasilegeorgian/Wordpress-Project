 ...
 */
class FaithLifeTV extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://faithlifetv.com/api/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['faithlifetv.com'];
    /** inline {@inheritdoc} */
    protected $httpsSupport = \true;
    /** inline {@inheritdoc} */
    public function validateUrl(\DevOwl\RealCookieBanner\Vendor\Embera\Url $url)
    {
        return (bool) (\preg_match('~faithlifetv\\.com/(items|media)/([^/]+)$~i', (string) $url) || \preg_match('~faithlifetv\\.com/(items/resource|media/resource)/([^/]+)/([^/]+)$~i', (string) $url) || \preg_match('~faithlifetv\\.com/media/assets/([^/]+)$~i', (string) $url));
    }
    /** inline {@inheritdoc} */
    ...
    public function getFakeResponse()
    {
        ...
        return ['type' => 'video', 'provider_name' => 'FaithLifeTV', 'provider_url' => 'https://faithlifetv.com', 'title' => 'Unknown title', 'html' => '<iframe ' . \implode(' ', $attr) . '></iframe>'];
    }
}
