 ...
 *
 */
class NaturalAtlas extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://naturalatlas.com/oembed.json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['naturalatlas.com'];
    /** inline {@inheritdoc} */
