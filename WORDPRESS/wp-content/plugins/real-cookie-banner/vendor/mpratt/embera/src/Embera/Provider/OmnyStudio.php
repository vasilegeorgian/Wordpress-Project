 ...
 *
 */
class OmnyStudio extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://omny.fm/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['omny.fm'];
    /** inline {@inheritdoc} */
