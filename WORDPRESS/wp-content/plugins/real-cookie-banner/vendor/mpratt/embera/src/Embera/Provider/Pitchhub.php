 ...
 *
 */
class Pitchhub extends \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderAdapter implements \DevOwl\RealCookieBanner\Vendor\Embera\Provider\ProviderInterface
{
    /** inline {@inheritdoc} */
    protected $endpoint = 'https://{subdomain}.pitchhub.com/en/public/oembed?format=json';
    /** inline {@inheritdoc} */
    protected static $hosts = ['*.pitchhub.com'];
    /** inline {@inheritdoc} */
