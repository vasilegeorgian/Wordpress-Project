 ...
 * @codeCoverageIgnore
 */
class BunnyCDNCacheImpl extends \DevOwl\RealCookieBanner\Vendor\DevOwl\CacheInvalidate\AbstractCache {
    ...
    public function invalidate() {
        ...
        $response = wp_remote_post(
            \sprintf('https://bunnycdn.com/api/pullzone/purgeCacheByHostname?hostname=%s', \urlencode($cdnDomainName)),
            ['timeout' => 5, 'headers' => ['AccessKey' => $apiKey]]
        );
