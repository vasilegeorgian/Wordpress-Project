 ...
 * @codeCoverageIgnore
 */
class MergeMinifyRefreshImpl extends \DevOwl\RealCookieBanner\Vendor\DevOwl\CacheInvalidate\AbstractCache {
    ...
    public function excludeAssetsHook($excludeAssets) {
        foreach (['js', 'css'] as $type) {
            add_filter(
                \sprintf('mmr_ignored_%s_sources', $type),
                function ($excluded) use ($excludeAssets, $type) {
