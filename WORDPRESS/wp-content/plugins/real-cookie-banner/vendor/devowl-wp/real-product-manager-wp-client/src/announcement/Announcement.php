...
class Announcement {
    ...
    public function isVisible() {
        return $this->getVisibility() ===
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement::VISIBILITY_LOCAL
            ? $this->getPool()
                ->getPluginUpdate()
                ->getInitiator()
    ...
    public static function fromResponse($pool, $response) {
        return new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\announcement\Announcement(
            $pool,
            $response['id'],
