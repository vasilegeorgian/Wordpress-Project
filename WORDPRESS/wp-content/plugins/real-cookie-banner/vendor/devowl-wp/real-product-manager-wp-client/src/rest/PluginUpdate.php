...
class PluginUpdate {
    ...
    public function rest_api_init() {
        ...
        register_rest_route($namespace, '/plugin-update/(?P<slug>[a-zA-Z0-9_-]+)/license/(?P<blogId>[0-9_-]+)/retry', [
            'methods' => 'POST',
    ...
    protected function getResult($slug) {
        ...
        return [
            ...
            'licenseKeyHelpUrl' => $initiator->getLicenseKeyHelpUrl(),
            ...
            'checkUpdateLink' => $initiator
                ...
                ->getCheckUpdateLink(),
            'showBlogName' => is_multisite(),
            'showNetworkWideUpdateIssueNotice' => is_multisite()
