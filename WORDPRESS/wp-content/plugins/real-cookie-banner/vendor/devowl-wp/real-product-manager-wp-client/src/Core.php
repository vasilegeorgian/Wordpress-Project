...
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\rest\PluginUpdate as RestPluginUpdate;
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\rest\Announcement as RestAnnouncement;
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\rest\Feedback as RestFeedback;
...
class Core {
    ...
    private function __construct() {
        $this->assets = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Assets::instance();
        ...
        add_action('rest_api_init', [
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\rest\PluginUpdate::instance(),
            'rest_api_init'
        ]);
        add_action('rest_api_init', [
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\rest\Announcement::instance(),
            'rest_api_init'
        ]);
        add_action('rest_api_init', [
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\rest\Feedback::instance(),
            'rest_api_init'
        ]);
    }
    /**
    ...
    public static function getInstance() {
        return !isset(self::$me)
            ? (self::$me = new \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Core())
            : self::$me;
    }
}
