...
abstract class AbstractSyncPlugin extends \DevOwl\RealCookieBanner\Vendor\DevOwl\Multilingual\AbstractLanguagePlugin {
    ...
    public function copyPostTaxonomies($from, $to, $taxonomies, $locale) {
        $doCopy = function ($post_id, $terms, $taxonomy) use ($locale) {
            ...
            \DevOwl\RealCookieBanner\Vendor\DevOwl\Multilingual\Utils::withoutFilters(
                'set_object_terms',
                function () use ($post_id, $copyIds, $taxonomy) {
        ...
        add_action(
            'set_object_terms',
            function ($object_id, $terms, $tt_ids, $taxonomy, $append) use ($from, $to, $taxonomies, $doCopy) {
    ...
    public function filterMetaValue($type, $from, $to, $meta_key, $meta_value, $locale) {
        ...
        if (\DevOwl\RealCookieBanner\Vendor\DevOwl\Multilingual\Utils::isJson($meta_value)) {
