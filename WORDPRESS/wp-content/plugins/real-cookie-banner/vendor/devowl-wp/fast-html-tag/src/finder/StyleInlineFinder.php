 ...
 * Find inline styles.
 */
class StyleInlineFinder extends \DevOwl\RealCookieBanner\Vendor\DevOwl\FastHtmlTag\finder\AbstractRegexFinder {
    /**
    ...
    public function createMatch($m) {
        ...
        return new \DevOwl\RealCookieBanner\Vendor\DevOwl\FastHtmlTag\finder\match\StyleInlineMatch(
            $this,
            $m[0],
            $attributes,
            $style
