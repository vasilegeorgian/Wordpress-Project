 ...
 */
class AttributeJsonBlocker extends \DevOwl\RealCookieBanner\Vendor\DevOwl\HeadlessContentBlocker\AbstractPlugin {
    /**
    ...
    public function checkResult($result, $matcher, $match) {
        if ($result->isBlocked()) {
            foreach ($this->attributes as $attribute) {
                ...
                if (\DevOwl\RealCookieBanner\Vendor\DevOwl\FastHtmlTag\Utils::isJson($value)) {
