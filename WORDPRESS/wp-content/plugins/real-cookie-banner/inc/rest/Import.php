...
class Import {
    ...
    public function rest_api_init() {
        ...
        register_rest_route($namespace, '/import', [
            ...
            'args' => [
                ...
                'cookieGroup' => ['type' => 'number', 'required' => \true],
                'cookieStatus' => [
                    'type' => 'enum',
                    'enum' => \DevOwl\RealCookieBanner\import\Import::IMPORT_POST_STATI,
                    'required' => \true
                ],
                'cookieSkipExisting' => ['type' => 'boolean', 'default' => \true],
                'blockerStatus' => [
                    'type' => 'enum',
                    'enum' => \DevOwl\RealCookieBanner\import\Import::IMPORT_POST_STATI,
                    'required' => \true
                ],
                'blockerSkipExisting' => ['type' => 'boolean', 'default' => \true],
        ...
        register_rest_route($namespace, '/export', [
            'methods' => 'GET',
            'callback' => [$this, 'routeExport'],
            'permission_callback' => [$this, 'permission_callback'],
            'args' => [
                'download' => ['type' => 'boolean'],
                'settings' => ['type' => 'boolean', 'default' => \true],
                'cookieGroups' => ['type' => 'boolean', 'default' => \true],
                'cookies' => ['type' => 'boolean', 'default' => \true],
                'blocker' => ['type' => 'boolean', 'default' => \true],
                'tcfVendorConfigurations' => ['type' => 'boolean', 'default' => \false],
                'customizeBanner' => ['type' => 'boolean', 'default' => \true]
            ]
        ]);
        register_rest_route($namespace, '/export/consents', [
            'methods' => 'GET',
            'callback' => [$this, 'routeExportConsents'],
            'permission_callback' => [$this, 'permission_callback'],
            'args' => [
                'uuid' => ['type' => 'string'],
                'from' => [
    ...
    public function routeImport($request) {
        // Prepare importer
        $result = \DevOwl\RealCookieBanner\import\Import::instance(\json_decode($request->get_param('json'), ARRAY_A));
    ...
    public function routeExport($request) {
        global $wpdb;
        $result = \DevOwl\RealCookieBanner\import\Export::instance();
    ...
    public function routeExportConsents($request) {
        ...
        \DevOwl\RealCookieBanner\import\ExportConsent::instance()->downloadCsv($uuid, $from, $to);
    }
    /**
     * New instance.
     */
