 ...
 */
class CountryBypass implements \DevOwl\RealCookieBanner\overrides\interfce\settings\IOverrideCountryBypass {
    ...
    const DEFAULT_COUNTRY_BYPASS_COUNTRIES = 'GDPR,CCPA,GB';
