 ...
 */
class PluginAutoplay extends \DevOwl\RealCookieBanner\Vendor\DevOwl\HeadlessContentBlocker\plugins\Autoplay {
    use UtilsProvider;
    /**
     * See `AbstractPlugin`.
     *
    ...
    public function blockedMatch($result, $matcher, $match) {
        if (
            ...
            if (
                ...
                $match->hasAttribute('class') &&
                \strpos($match->getAttribute('class'), 'tb_') !== \false
            ) {
