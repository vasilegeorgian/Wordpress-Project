...
<div <?php echo self::get_element_attributes( self::sticky_element_props( $container_props, $fields_args ) ); ?>>
    ...
    <a href="<?php echo $is_overlay===true ? '#'.$overlay_id:'#'; ?>" class="tb_ov_co_icon_wrapper tf_inline_b<?php echo empty($icon)?' tb_ov_no_icon':'';?>">
    ...
    <div id="<?php echo $overlay_id; ?>" style="<?php echo $overlay_style; ?>" class="tb_oc_overlay tf_scrollbar tf_box<?php echo $is_overlay===true ? ' sidemenu sidemenu-off tb_content_overlay_'.$fields_args['style']:' tb_oc_expandable tf_abs tf_w tf_h'; ?>">
            ...
            <a id="<?php echo $overlay_id; ?>_close" class="tb_ov_close tf_box"><span class="tb_ov_close_inner tf_close tf_rel"></span></a>
                    <?php endif; ?>
