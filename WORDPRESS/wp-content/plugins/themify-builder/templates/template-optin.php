	    ...
	    >
            ...
            <?php if (!empty($captcha_site_key) && !empty($captcha_secret_key) ) : ?>
                ...
                <div class="tb_optin_captcha">
                    <div class="themify_captcha_field <?php if ( 'v2' === $recaptcha_version ) :?>g-recaptcha<?php endif; ?>" data-sitekey="<?php echo esc_attr($captcha_site_key); ?>" data-ver="<?php esc_attr_e($recaptcha_version); ?>"></div>
                </div>
            <?php endif; ?>
