...
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
    ...
    <ul class="<?php echo $ui_class ?>"<?php if ( $schema ) : ?> itemscope itemtype="https://schema.org/FAQPage"<?php endif; ?>>
	<?php
	...
	foreach ($content_accordion as $i=>$content):
	    ...
	    ?>
	    <li<?php if ($isOpen===true):?> class="builder-accordion-active"<?php endif;?><?php if ( $schema ) : ?> itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"<?php endif; ?>>
			<div class="accordion-title tf_rel"<?php if ( $schema ) : ?> itemprop="name"<?php endif; ?>>
			...
			<div id="acc-<?php echo $tab_id . '-' . $i; ?>-content" data-id="acc-<?php echo $tab_id . '-' . $i; ?>" aria-hidden="<?php echo $isOpen===true? 'false' : 'true' ; ?>" class="accordion-content<?php if ($isOpen===false): ?> tf_hide<?php endif; ?>"<?php if ( $schema ) : ?> itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"<?php endif; ?>>

				<?php if ( $content['text_accordion'] !== '' ) : ?>
					<div<?php if ( $schema ) : ?> itemprop="text"<?php endif; ?>
						class="tb_text_wrap"
