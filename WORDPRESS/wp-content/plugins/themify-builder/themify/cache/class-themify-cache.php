        ...
        public static function getBuffer($html){
            ...
            if(self::$error===false && !empty($html)){
                ...
                if(self::$stopCache===false){
                    ...
                    if( (is_dir($dir) || mkdir($dir,0777, true)) && !is_file(self::$cache_dir)){
                        ...
                        if(file_put_contents(self::$cache_dir.'tmp','<!--THEMIFY CACHE-->'.$html) && rename(self::$cache_dir.'tmp',self::$cache_dir)!==false){
                            ...
                            clearstatcache();
                            if(is_file(self::$cache_dir.'tmp')){
                                unlink(self::$cache_dir.'tmp');
                            }
                        }
                    }
                }
