...
c[k[n]]&&(g=d.createElement("li"),g.textContent=k[n],r.appendChild(g),c[k[n]]=1)}}b.layout_lists.appendChild(e)},init(){b.layout_lists.addEventListener("click",function(a){if(a.target.closest("li")){const c=b.layout_lists.querySelector(".selected");c&&c.classList.remove("selected");a.target.closest("li").classList.add("selected")}});b.container.querySelector(".tbbp_close").addEventListener("click",function(){b.hidePanel()});b.container.querySelector(".tbbp_search_container input").addEventListener("keyup",
