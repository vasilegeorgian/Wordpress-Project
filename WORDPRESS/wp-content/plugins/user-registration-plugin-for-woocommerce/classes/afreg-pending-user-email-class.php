...
if ( !class_exists( 'Addify_Registration_Fields_Pending_User_Email' ) ) { 
	...
	class Addify_Registration_Fields_Pending_User_Email extends WC_Email {
		...
		public function __construct() { 
			...
			$this->template_html  = 'emails/afreg-pending-user-email-user.php'; // HTML template path
			$this->template_plain = 'emails/plain/afreg-pending-user-email-user.php'; // Plain template path
