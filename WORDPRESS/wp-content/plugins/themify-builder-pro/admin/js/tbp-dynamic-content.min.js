...
b&&"SELECT"!==a.nodeName&&Themify.triggerEvent(a,"keyup")))},F=function(a){a=a.getAttribute("data-type");"imageGradient"===a?a="image":"title"===a&&(a="text");return a},I=function(){const a={};l.each(tbpDynamic.items,function(c,b){l.each(b.type,function(b,c){void 0===a[c]&&(a[c]=c)})});a.title="title";a.imageGradient="imageGradient";return Object.keys(a)},z=function(a){const c=tbpDynamic.excludes,b=tbpDynamic.d_label,d=I();var e=!1;for(let f=d.length-1;-1<f;--f){let h=a.querySelectorAll('.tb_field[data-type="'+
d[f]+'"]');for(let a=h.length-1;-1<a;--a)if(!h[a].classList.contains("tb_has_dc")&&!h[a].classList.contains("tb_disable_dc")){e=!1;for(var g=c.length-1;-1<g;--g)if(h[a].classList.contains(c[g])){e=!0;break}if(!1===e){h[a].className+=" tb_has_dc";e=document.createElement("label");g=document.createElement("input");let c=document.createElement("div");e.className="tpb_dc_toggle switch-wrapper";g.type="checkbox";g.className="toggle_switch";c.className="switch_label";c.setAttribute("data-on",b);c.setAttribute("data-off",
b);g.addEventListener("change",function(a){a.stopPropagation();C(this)},{passive:!0});e.appendChild(g);e.appendChild(c);h[a].insertBefore(e,h[a].firstChild);C(g,!0)}}}};l(window).one("load",function(){Themify.requestIdleCallback(function(){if("visual"!==k.mode||!0===Themify.is_builder_loaded)setTimeout(x,1500);else window.top.Themify.body.one("themify_builder_ready",function(a){setTimeout(x,2500)});l(document).on("tb_repeatable_add_new tb_repeatable_duplicate tb_repeatable_delete",function(a){"tb_repeatable_delete"===
...
z(c)});Themify.body.on("themify_builder_tabsactive tb_options_expand",function(a,c,b){if(null!==k.activeModel){let d=ThemifyConstructor.clicked;setTimeout(function(){d=ThemifyConstructor.clicked;"animation"!==d&&"visibility"!==d&&("tb_options_expand"===a.type&&(b=c,c=null),"styling"===d&&null!==c&&-1!==c.indexOf("_h")||z(b))},"setting"===d?0:50)}})},15)})})(jQuery,tb_app);
