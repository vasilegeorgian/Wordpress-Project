...
const q=a.closest(".tbp_condition_repeat").getAttribute("data-index");var p=f.count;const x=f.limit;h.innerHTML="";k.className="tbp_pagination_result";for(let a in t){let d=b.createElement("label"),c=b.createElement("input");c.type="checkbox";c.value=a;c.name=l;void 0!==r[q]&&void 0!==r[q][a]&&(c.checked=!0);d.appendChild(c);d.insertAdjacentHTML("beforeend",t[a]);m.appendChild(d)}k.appendChild(m);h.appendChild(k);if(p>x){m=b.createElement("div");t=b.createDocumentFragment();m.className="tbp_pagination_list";
for(let a=1,d=Math.ceil(p/x);a<=d;++a)p=b.createElement("a"),p.href="#",p.className="page_numbers",p.textContent=a,c===a&&(p.className+=" current"),p.setAttribute("data-number",a),t.appendChild(p);m.appendChild(t);m.addEventListener("click",function(b){b.preventDefault();b.stopPropagation();b=b.target.getAttribute("data-number");e.saveCheckboxes(a);b&&e.loadData(a,b,d,g)});h.appendChild(m)}k=k.closest(".tbp_pagination_search").getElementsByClassName("tbp_pagination_search_input")[0];void 0!==k&&void 0===
d&&(k.addEventListener("search",n),k.addEventListener("input",n));g&&g(f,h,c)},n=function(b){b.preventDefault();b.stopPropagation();d=b.target.value;e.isSearching=!0;e.saveCheckboxes(a);1<d.length?e.loadData(a,1,d,g):(m[l]={},e.loadData(a,1,null,g))};void 0===m[l]||void 0===m[l][c]||e.isSearching?p.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",beforeSend(){h.classList.add("tb_busy")},data:{action:"tbp_load_data",p:c,s:d,type:l,tb_load_nonce:themifyBuilder.tb_load_nonce},complete(){h.classList.remove("tb_busy")},
success(a){void 0===m[l]&&(m[l]={});(m[l][c]=a)&&0<a.count&&k(a);e.isSearching=!1}}):0<m[l][c].count&&k(m[l][c])}},saveCheckboxes(a){const b=a.getElementsByTagName("input");a=a.closest(".tbp_condition_repeat").getAttribute("data-index");void 0===r[a]&&(r[a]={});for(let d=b.length-1;-1<d;--d){let c=b[d].value;!0===b[d].checked?r[a][c]=!0:void 0!==r[a][c]&&delete r[a][c]}},renderRepeat(a,c,d,g){const f=b.createDocumentFragment(),h=b.createElement("div"),e=b.createElement("div"),l=b.createElement("a");
h.className="tbp_condition_repeat";e.className="tbp_condition_repeat_inner";c=null!==c?c:this.setIndex();h.setAttribute("data-index",c);l.className="ti-close tbp_delete_repeater";l.href="#";e.appendChild(this.includeRender(d,g));e.appendChild(this.renderGeneral(a,d,c));f.appendChild(e);f.appendChild(l);h.appendChild(f);l.addEventListener("click",function(a){a.preventDefault();a=h.closest(".tbp_condition_repeat").dataset.index;void 0!==r[a]&&delete r[a];h.parentNode.removeChild(h)});return h},render(a,
c){this.id=a.id;const d=b.createElement("div"),f=b.createElement("a"),g=q.type;d.className="tb_lb_option tbp_condition_wrap";d.id=a.id;null===q.conditions&&(q.conditions=a);if(void 0!==a.options[g]){f.className="add_new tf_plus_icon";f.href="#";f.textContent=_tbp_app.add_conition;const h=b.createDocumentFragment();let e=ThemifyConstructor.values[a.id];if(void 0===e||0===e.length)e=[{}];for(let b=0,d=e.length;b<d;++b)h.appendChild(this.renderRepeat(a.options[g],b,e[b],c));d.appendChild(h);f.addEventListener("click",
function(b){b.preventDefault();const d=this.renderRepeat(a.options[g],null,{},c);b.currentTarget.before(d)}.bind(this));d.appendChild(f)}return d},setIndex(){const a=g.lightboxContainer.getElementsByClassName("tbp_condition_repeat");let b=void 0!==a[0]?parseInt(a[0].getAttribute("data-index")):0;for(let c=a.length-1;0<c;--c){let d=parseInt(a[c].getAttribute("data-index"));b<d&&(b=d)}return++b},addSelectWrapper(a,c){const d=b.createElement("div");d.className="selectwrapper tbp_inner_block";void 0!==
c&&(d.className+=" tbp_block_item tbp_block_"+c,a.setAttribute("data-id",c));d.appendChild(a);return d}};c.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();b.body.click();a=g.lightbox.getElementsByClassName("tb_lb_option");const c={};for(let b=a.length-1;-1<b;--b)if(a[b].classList.contains("tbp_condition_wrap")){let f=a[b].getElementsByClassName("tbp_condition_repeat"),g=[];for(let a=0,b=f.length;a<b;++a){g[a]={};let b=f[a].getElementsByClassName("tbp_inner_block");for(let c=
b.length-1;-1<c;--c)if(null!==b[c].offsetParent){var d=b[c].classList;d.contains("tbp_include")?(d=b[c].getElementsByTagName("select")[0],"in"!==d.value&&(g[a][d.getAttribute("data-id")]=d.value)):d.contains("tbp_pagination_wrapper")?!0!==b[c].getElementsByClassName("tbp_pagination_all")[0].checked&&(d=f[a].getAttribute("data-index"),void 0!==r[d]&&(g[a].detail=r[d])):d.contains("tbp_block_item")&&(d=b[c].getElementsByTagName("select")[0],g[a][d.getAttribute("data-id")]=d.value)}}c[a[b].getAttribute("id")]=
