...
class TB_Add_To_Cart_Module extends Themify_Builder_Component_Module {
    ...
    public function get_options() {
		return array(
			...
			array(
				...
				'label' => __('Variable Product Label', 'themify')
			),
			array(
				'id' => 'variable_cart',
				'type' => 'toggle_switch',
				'label' => __( 'Variable Product Add to Cart', 'themify' ),
				'options' => array(
					'on'=>array( 'name' => 'yes' )
				),
			...
			array(
				...
				'label' => __('Out of Stock Label', 'themify')
			),
			array(
				'id' => 'fullwidth',
				'type' => 'toggle_switch',
	...
	public function get_styling() {
		...
		return array(
			...
			'options' => array(
				...
				'vs' => array(
					'label' => __('Variable Select', 'themify'),
	...
	public function get_live_default() {
		return array(
			...
			'label_variable' => __('View Options', 'themify'),
			'label_outofstock' => __('Read More', 'themify'),
		);
	}
