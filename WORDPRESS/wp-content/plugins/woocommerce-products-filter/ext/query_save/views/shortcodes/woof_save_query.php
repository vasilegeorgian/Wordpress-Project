        ...
        <div class="woof_container_inner">
            ...
            if ($show_btn OR class_exists("WOOF_EXT_TURBO_MODE")) { // hide btn without search query
                ...
                <div class="woof_add_query_count" style="display: <?php echo esc_attr($visible) ?>" >
                    ...
                    <input name="add_query_save" data-count="<?php echo esc_attr($query_count) ?>" type="button" class="woof_add_query_save" data-user="<?php echo esc_attr($cur_user_id) ?>" value="<?php esc_html_e($btn_label) ?>"  >
                </div>
