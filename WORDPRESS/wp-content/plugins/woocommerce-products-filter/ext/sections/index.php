...
//lets print our items and taxonomies
        ...
        <li class="woof_section_item" data-key='<?php echo esc_attr($ukey); ?>'>
            <input type="text" name="woof_settings[sections][<?php echo esc_attr($ukey); ?>][title]" value="<?php esc_html_e($title ? esc_html($title) : esc_html__("New section", 'woocommerce-products-filter')) ?>">
