...
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][search_option]" value="<?php esc_html_e((isset($settings[$key]['search_option'])) ? $settings[$key]['search_option'] : 0); ?>" /> 
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][search_value]" value="<?php esc_html_e((isset($settings[$key]['search_value'])) ? $settings[$key]['search_value'] : ""); ?>" /> 
