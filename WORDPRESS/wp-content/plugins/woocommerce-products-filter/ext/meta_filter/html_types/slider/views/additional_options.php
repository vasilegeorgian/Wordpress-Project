...
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][range]" value="<?php esc_html_e(isset($settings[$key]['range']) ? $settings[$key]['range'] : "1-100") ?>" />
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][prefix]" value="<?php esc_html_e(isset($settings[$key]['prefix']) ? $settings[$key]['prefix'] : "") ?>" />
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][postfix]" value="<?php esc_html_e(isset($settings[$key]['postfix']) ? $settings[$key]['postfix'] : "") ?>" />
...
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][meta_slider_skin]" value="<?php esc_html_e(isset($settings[$key]['meta_slider_skin']) ? $settings[$key]['meta_slider_skin'] : 0) ?>" />
