            ...
            <div class="woof_container_inner woof_container_inner_datepicker_slider">
                ...
                <div class="<?php echo esc_attr($css_classes) ?>">
                    <div class="woof_meta_datepicker_container">
                        <input class="woof_meta_datepicker_data" type="hidden" name="<?php echo esc_attr($meta_key) ?>_from" value="<?php esc_html_e($from) ?>" />

                        <input id="<?php echo esc_attr($date_id) ?>_from" data-format="<?php esc_html_e($format) ?>" type="text" readonly="readonly" data-meta-key="<?php echo esc_attr($meta_key) ?>" class="woof_calendar woof_calendar_from" placeholder="<?php esc_html_e('from', 'woocommerce-products-filter') ?>" />
                    ...
                    <div class="woof_meta_datepicker_container">
                        <input class="woof_meta_datepicker_data" type="hidden" name="<?php echo esc_attr($meta_key) ?>_to" value="<?php esc_html_e($to) ?>" />
                ...
                <input type="hidden" value="<?php esc_html_e($top_panel_txt) ?>" data-anchor="woof_n_<?php echo esc_attr("datepicker_" . $meta_key) ?>_<?php echo esc_attr($current_request_txt) ?>" />
            </div>
        </div>
    </div>
<?php endif; ?>
