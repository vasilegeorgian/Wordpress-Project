...
<input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][text_conditional]" value="<?php esc_html_e(isset($settings[$key]['text_conditional'])? $settings[$key]['text_conditional']:'LIKE') ?>" /> 
