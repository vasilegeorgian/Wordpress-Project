    ...
    <div class="woof_container_inner">
        <div class="woof_container_inner woof_container_inner_meta_mselect">
            ...
            <div class="<?php echo esc_attr($css_classes) ?>">
                ...
                <label class="woof_wcga_label_hide"  for="<?php echo esc_attr($meta_id) ?>"><?php esc_html_e(WOOF_HELPER::wpml_translate(null, $options['title'])) ?></label>					
                <select id="<?php echo esc_attr($meta_id) ?>" class="woof_meta_mselect woof_meta_mselect_<?php echo esc_attr($meta_key) ?>" name="<?php echo esc_attr("mselect_" . $meta_key) ?>"multiple="multiple" data-placeholder="<?php esc_html_e(WOOF_HELPER::wpml_translate(null, $options['title'])) ?>" data-options_separator="<?php esc_html_e($options_separator); ?>">
                ...
                foreach ($woof_value as $key_val) {
                    ...
                    ?>   
                    <input type="hidden" value="<?php esc_html_e(WOOF_HELPER::wpml_translate(null, $curr_title)); ?>" data-anchor="woof_n_<?php echo esc_attr("mselect_" . $meta_key) ?>_<?php echo esc_attr($key_val) ?>" />
                <?php } ?>
