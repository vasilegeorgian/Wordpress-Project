...
<dl class="woof_select_radio_check">
    ...
    <dt>
        <a href="javascript: void(0);" class="woof_select_radio_check_opener">
            <span class="woof_hida woof_hida_<?php echo esc_attr($tax_slug) ?>" data-title="<?php esc_html_e(WOOF_HELPER::wpml_translate($taxonomy_info)) ?>"><?php esc_html_e(WOOF_HELPER::wpml_translate($taxonomy_info)) ?></span>    
