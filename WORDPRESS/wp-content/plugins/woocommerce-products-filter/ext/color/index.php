                ...
                foreach ($terms as $t) {
                    ...
                    <li>
                        <table>
                            <tr>
                                <td valign="top">
                                    <input type="text" name="woof_settings[color][<?php echo esc_attr($key) ?>][<?php echo esc_attr($t['slug']) ?>]" value="<?php esc_html_e($color) ?>" id="woof_color_picker_<?php echo esc_attr($t['slug']) ?>" class="woof-color-picker" >
                                </td>
                                <td>
