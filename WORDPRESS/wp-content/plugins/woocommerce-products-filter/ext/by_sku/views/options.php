...
<li data-key="<?php echo esc_attr($key) ?>" class="woof_options_li">
    ...
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][logic]" value="<?php esc_html_e($woof_settings[$key]['logic']) ?>" />
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][autocomplete]" value="<?php esc_html_e($woof_settings[$key]['autocomplete']) ?>" />
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][autocomplete_items]" value="<?php esc_html_e($woof_settings[$key]['autocomplete_items']) ?>" />
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][use_for]" value="<?php esc_html_e($woof_settings[$key]['use_for']) ?>" />
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][title]" value="<?php esc_html_e($woof_settings[$key]['title']) ?>" />
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][placeholder]" value="<?php esc_html_e($woof_settings[$key]['placeholder']) ?>" />
    ...
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][reset_behavior]" value="<?php esc_html_e($woof_settings[$key]['reset_behavior']) ?>" />
