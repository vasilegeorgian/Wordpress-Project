...
<li data-key="<?php echo esc_attr($key) ?>" class="woof_options_li">
    ...
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][role]" value="<?php esc_html_e($woof_settings[$key]['role']) ?>" />
    <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][view]" value="<?php esc_html_e($woof_settings[$key]['view']) ?>" />
