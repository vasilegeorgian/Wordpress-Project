                            ...
                            case 'text':
                                ...
                                <div class="woof_option_container woof_option_<?php echo esc_attr($obj->html_type) ?>">
                                    ...
                                    <div class="woof-form-element-container">
                                        ...
                                        <div class="woof-form-element">
                                            <input type="text" class="woof_popup_option regular-text code" data-option="<?php echo esc_attr($key) ?>" placeholder="<?php esc_html_e(isset($option['placeholder']) ? $option['placeholder'] : '') ?>" value="" />
                                        </div>
                            ...
                            case 'image':
                                ...
                                <div class="woof_option_container woof_option_<?php echo esc_attr($obj->html_type) ?>">
                                    ...
                                    <div class="woof-form-element-container">
                                        ...
                                        <div class="woof-form-element">
                                            <input type="text" class="woof_popup_option regular-text code" data-option="<?php echo esc_attr($key) ?>" placeholder="<?php esc_html_e($option['placeholder']) ?>" value="" />
            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <a href="https://pluginus.net/affiliate/woocommerce-currency-switcher" target="_blank"><img src="<?php echo esc_url(WOOF_LINK) ?>img/plugin_options/banners/woof.png" alt="<?php esc_html_e("full version of the plugin", 'woocommerce-products-filter'); ?>"></a>
                    </td>
...
function woof_print_tax($key, $tax, $woof_settings) {
    ...
    <li data-key="<?php echo esc_attr($key) ?>" class="woof_options_li">
        ...
        <div class="select-wrap">
            <select name="woof_settings[tax_type][<?php echo esc_attr($key) ?>]" class="woof_select_tax_type">
                <?php foreach (woof()->html_types as $type => $type_text) : ?>
                    <option value="<?php esc_html_e($type) ?>" <?php if (isset($woof_settings['tax_type'][$key])) selected($woof_settings['tax_type'][$key], $type) ?>><?php esc_html_e($type_text) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <input type="text" class="woof_excluded_terms" name="woof_settings[excluded_terms][<?php echo esc_attr($key) ?>]" placeholder="<?php esc_html_e('excluded terms ids', 'woocommerce-products-filter') ?>" value="<?php esc_html_e($excluded_terms) ?>" />
        <?php
        $rev_id = uniqid('re-');
        $rev_checked = false;
        ...
        <a href="#" data-taxonomy="<?php echo esc_attr($key) ?>" data-taxonomy-name="<?php esc_html_e($tax->labels->name) ?>" class="woof-button js_woof_add_options help_tip" data-tip="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>"><span class="icon-cog-outline"></span></a>
        ...
        <div style="display: none;">
            ...
            ?>
            <input type="text" name="woof_settings[tax_block_height][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($max_height) ?>" />
            <?php
            $show_title_label = 0;
            ...
            ?>
            <input type="text" name="woof_settings[show_title_label][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($show_title_label) ?>" />
            ...
            ?>
            <input type="text" name="woof_settings[tooltip_text][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($tooltip_text) ?>" />
            ...
            ?>
            <input type="text" name="woof_settings[dispay_in_row][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($dispay_in_row) ?>" />
            ...
            ?>
            <input type="text" name="woof_settings[orderby][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($orderby) ?>" />
            ...
            ?>
            <input type="text" name="woof_settings[order][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($order) ?>" />
            <?php
            $comparison_logic = 'OR';
            ...
            ?>
            <input type="text" name="woof_settings[comparison_logic][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($comparison_logic) ?>" />
            ...
            ?>
            <input type="text" name="woof_settings[custom_tax_label][<?php echo esc_attr($key) ?>]" placeholder="" value="<?php esc_html_e($custom_tax_label) ?>" />
                ...
                foreach (WOOF_EXT::$includes['taxonomy_type_objects'] as $obj) {
                    if (!empty($obj->taxonomy_type_additional_options)) {
                        foreach ($obj->taxonomy_type_additional_options as $option_key => $option) {
                            ...
                            ?>
                            <input type="text" name="woof_settings[<?php echo esc_attr($option_key) ?>][<?php echo esc_attr($key) ?>]" value="<?php esc_html_e($option_val) ?>" />
                            <?php
                        }
                    }
                }
    ...
    switch ($key) {
        case 'by_price':
            ...
            <li data-key="<?php echo esc_attr($key) ?>" class="woof_options_li">
                ...
                <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][title_text]" value="<?php esc_html_e($woof_settings[$key]['title_text']) ?>" />
                <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][show_toggle_button]" value="<?php esc_html_e($woof_settings[$key]['show_toggle_button']) ?>" />
                <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][ranges]" value="<?php esc_html_e($woof_settings[$key]['ranges']) ?>" />
                <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][first_option_text]" value="<?php esc_html_e($woof_settings[$key]['first_option_text']) ?>" />
                ...
                <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][price_tax]" value="<?php esc_html_e($woof_settings[$key]['price_tax']) ?>" />
                ...
                <input type="hidden" name="woof_settings[<?php echo esc_attr($key) ?>][price_slider_skin]" value="<?php esc_html_e($woof_settings[$key]['price_slider_skin']) ?>" />
            </li>
            <?php
            break;
