    ...
    <div class="woof-control-container">
        <div class="woof-control">
            ...
            switch ($type)
            {
                ...
                case 'color':
                    ?>
                    <input type="text" placeholder="<?php echo esc_attr($placeholder) ?>" class="woof-color-picker" name="woof_settings[<?php echo esc_attr($key) ?>]" value="<?php esc_html_e($woof_settings[$key]) ?>" id="<?php echo esc_attr($key) ?>" />
                    <?php
                    break;
                case 'select':
                    ?>
                ...
                case 'image':
                    ?>
                        <input type="text" name="woof_settings[<?php echo esc_attr($key) ?>]" value="<?php esc_html_e($woof_settings[$key]) ?>" id="<?php echo esc_attr($key) ?>" />
