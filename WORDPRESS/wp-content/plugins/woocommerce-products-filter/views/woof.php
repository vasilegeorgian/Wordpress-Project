    ...
    function woof_print_tax($taxonomies, $tax_slug, $terms, $exclude_tax_key, $taxonomies_info, $additional_taxes, $woof_settings, $args, $counter) {
        ...
        <div data-css-class="woof_container_<?php echo esc_attr($tax_slug) ?>" class="woof_container woof_container_<?php echo esc_attr($woof_settings['tax_type'][$tax_slug]) ?> woof_container_<?php echo esc_attr($tax_slug) ?> woof_container_<?php echo esc_attr($counter) ?> woof_container_<?php echo esc_attr($primax_class) ?>">
            ...
            <div class="woof_container_inner woof_container_inner_<?php echo esc_attr($primax_class) ?>">
                ...
                <input type="hidden" name="woof_t_<?php echo esc_attr($tax_slug) ?>" value="<?php esc_html_e($taxonomies_info[$tax_slug]->labels->name) ?>" /><!-- for red button search nav panel -->
...
<?php if ($autohide): ?>
    <div style="position: relative;">
        ...
        <div class="woof_auto_show woof_overflow_hidden" style="opacity: 0; height: 1px;">
            ...
            <div class="woof <?php if (!empty($sid)): ?>woof_sid woof_sid_<?php echo esc_attr($sid) ?><?php endif; ?> <?php echo esc_attr($woof_class) ?>" <?php if (!empty($sid)): ?>data-sid="<?php echo esc_attr($sid); ?>"<?php endif; ?> data-shortcode="<?php esc_html_e(WOOF_REQUEST::isset('woof_shortcode_txt') ? WOOF_REQUEST::get('woof_shortcode_txt') : 'woof') ?>" data-redirect="<?php echo esc_attr($redirect) ?>" data-autosubmit="<?php echo esc_attr($autosubmit) ?>" data-ajax-redraw="<?php echo esc_attr($ajax_redraw) ?>">
                <?php
