...
<div class="woof_price_filter_txt_container">
    ...
    <input id="<?php echo esc_attr($price_id) ?>_from" type="text" class="woof_price_filter_txt woof_price_filter_txt_from" placeholder="<?php esc_html_e($min_price_txt) ?>" data-value="<?php echo esc_attr($min_price_data) ?>" value="<?php echo esc_attr($min_price) ?>" />&nbsp;
    <label class="woof_wcga_label_hide"  for="<?php echo esc_attr($price_id) ?>_to"><?php esc_html_e($max_price_txt) ?></label>
    <input id="<?php echo esc_attr($price_id) ?>_to" type="text" class="woof_price_filter_txt woof_price_filter_txt_to" placeholder="<?php esc_html_e($max_price_txt) ?>" name="max_price" data-value="<?php echo esc_attr($max_price_data) ?>" value="<?php echo esc_attr($max_price) ?>" />
