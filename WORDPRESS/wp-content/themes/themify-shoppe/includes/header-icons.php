<div class="header-icons">
    ...
    <?php if (themify_theme_show_area('search_button')) : ?>
        <a data-lazy="1" class="search-button tf_search_icon tf_box" href="#"><?php echo themify_get_icon('search','ti',false,false,array('aria-label'=>__('Search','themify'))); ?><span class="screen-reader-text"><?php _e('Search','themify'); ?></span></a>
        <!-- /search-button -->
    <?php endif; ?>
</div>
