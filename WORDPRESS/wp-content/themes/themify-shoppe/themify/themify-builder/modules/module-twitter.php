		...
		$items = array(
			...
			self::get_tab(array(
				...
				'options' => array(
					...
					self::get_line_height(' li:hover', 'i_l_h'),
					self::get_text_transform(' li:hover', 'i_lt_h'),
		...
		$follow = array(
			...
			self::get_tab(array(
				...
				'options' => array(
					...
					self::get_line_height(' .tb_twitter_follow:hover', 'f_l_h'),
					self::get_text_transform(' .tb_twitter_follow:hover', 'f_lt_h'),
...
Themify_Builder_Model::register_module( 'TB_Twitter_Module' );