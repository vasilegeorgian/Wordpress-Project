...
function themify_theme_enqueue_header() {
	...
	if( themify_is_woocommerce_active() ) {
		...
		$themify_script_vars+= apply_filters(
			...
			array(	'redirect'=> get_option( 'woocommerce_cart_redirect_after_add' ) === 'yes' ? wc_get_cart_url() : false,
				'lng'=>array(
	...
	if('schedule'===themify_theme_is_dark_mode()){
		...
		$themify_script_vars['darkmode']= true;
	}
...
function themify_theme_load_builder_css($builder_id,$mod,$mod_id,$type){
...
add_action('themify_builder_background_styling','themify_theme_load_builder_css',10,4);
...
function themify_theme_after_skin(){
    if('always'===themify_theme_is_dark_mode()){
		...
		Themify_Enqueue_Assets::loadThemeStyleModule( 'dark-mode', 'none', true );
	}
}
