		...
		if (font) {
			if (font.family) {
				if (font.family.fonttype && ( 'google' === font.family.fonttype || 'cf' === font.family.fonttype )) {
					...
					if ( font.weight && String( font.weight ) !== '400' ) {
					   $font += ':normal,' + font.weight;
					   if ( font.italic && String( font.weight ).indexOf( 'i' ) === -1 ) {
						   $font += ',' + font.weight + 'i';
					   }
					}
			...
			if ( String( font.weight ).indexOf( 'i' ) !== -1 ) {
				font.italic = true;
			}
			...
			if (font.weight) {
				styles[$id]['font-weight'] = String( font.weight ).replace( 'i', '' );
			}
			else if(!font.bold){
