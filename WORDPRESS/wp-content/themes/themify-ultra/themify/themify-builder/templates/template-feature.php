...
if ( $fields_args['layout_mobile'] !== '' ) {
	...
	if ( ! in_array( $fields_args['layout_mobile'], [ $fields_args['layout_feature'], 'icon-top' ] ) ) {
		...
		<?php endif; ?>
			...
			<?php endif; ?>
				<span class="chart-html5-circle tf_w tf_h">
					<?php if ('icon' === $fields_args['icon_type_feature']) : ?>
						<?php if('' !== $fields_args['icon_feature']):?>
							<em class="module-feature-icon tf_rel"<?php echo!empty($fields_args['icon_color_feature']) ? ' style="color:' . esc_attr(Themify_Builder_Stylesheet::get_rgba_color($fields_args['icon_color_feature'])) . '"' : ''; ?>><?php echo themify_get_icon($fields_args['icon_feature']); ?></em>
						<?php endif;?>
				...
				<?php if ( 'both' === $fields_args['icon_type_feature'] ) : ?>
					<span class="module-feature-icon-wrap tf_abs"<?php if ( ! empty( $fields_args['icon_position'] ) ) : ?> style="transform: rotate(<?php echo $fields_args['icon_position'] ?>deg)"<?php endif; ?>>
						<span class="module-feature-icon" style="
							<?php if ( ! empty( $fields_args['icon_position'] ) ) : ?>transform: translateY(-50%) rotate(-<?php echo $fields_args['icon_position'] ?>deg); <?php endif; ?>
							<?php if ( ! empty( $fields_args['icon_color_feature'] ) ) : ?>color: <?php echo esc_attr( Themify_Builder_Stylesheet::get_rgba_color( $fields_args['icon_color_feature'] ) ); ?>;<?php endif; ?>
							<?php if ( ! empty( $fields_args['icon_bg_feature'] ) ) : ?>background-color: <?php echo esc_attr( Themify_Builder_Stylesheet::get_rgba_color( $fields_args['icon_bg_feature'] ) ); ?>;<?php endif; ?>
