...
class TB_Login_Module extends Themify_Builder_Component_Module {
	...
	<div class="module module-<?php echo $this->slug; ?> {{ data.css }}">
		...
		<p class="tb_login_submit tf_right">
		    <button contenteditable="false" data-name="label_log_in">{{ data.label_log_in }}</button>
		...
		<p class="tb_lostpassword_submit tf_right">
		    <button contenteditable="false" data-name="lostpasswordform_label_reset">{{ data.lostpasswordform_label_reset }}</button>
		    <input type="hidden" name="redirect_to">
		</p>
