...
class Themify_Hooks {
	...
	private static function get_location_groups() {
		return array(
			...
			'ecommerce' => __( 'WooCommerce', 'themify' ),
	...
	public static function register_default_hook_locations() {
		...
		if ( themify_is_woocommerce_active() ) {
			foreach ( array(
				...
				array( 'woocommerce_before_add_to_cart_form', 'before_add_to_cart_form', 'ecommerce' ),
				array( 'woocommerce_after_add_to_cart_form', 'after_add_to_cart_form', 'ecommerce' ),
				array( 'woocommerce_before_variations_form', 'before_variations_form', 'ecommerce' ),
				array( 'woocommerce_after_variations_form', 'after_variations_form', 'ecommerce' ),
				array( 'woocommerce_before_add_to_cart_button', 'before_add_to_cart_button', 'ecommerce' ),
				array( 'woocommerce_after_add_to_cart_button', 'after_add_to_cart_button', 'ecommerce' ),
				array( 'woocommerce_product_meta_start', 'product_meta_start', 'ecommerce' ),
				array( 'woocommerce_product_meta_end', 'product_meta_end', 'ecommerce' ),
	...
	private static function item_template( $id ) {
		...
		$output .= '<div class="row"><select name="' .  $pre . '-' . $id . '-location" class="width7">';
		...
		$output .= '<div class="row"><textarea class="widthfull" name="' . $pre . '-' . $id . '-code" rows="6" cols="73">' . esc_html( themify_get( "{$pre}-{$id}-code",false,true ) ) . '</textarea>';
